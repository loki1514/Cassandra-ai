...
class SmartStatusQueryProcessor:
    ...
    async def process_status_query(self, query_text: str, org_id: str,
        ...
        """
        # Step 1: Semantic search in Supermemory
        ...
        # Step 4: Generate response with provenance
        response = self._generate_response(ticket_info, live_status, top_memory)
    ...
    def _generate_response(self, ticket_info: Dict, live_status: Dict, 
        ...
        """Generate natural language response with provenance."""
