-- T21: Human Correction Loop — Transcript Speaker Correction
--
...
COMMENT ON COLUMN enriched_transcripts.original_speaker_user_id IS
    'The speaker_user_id that was assigned before human correction. '
    'Used for audit trail and potential revert.';
...
-- ── Index for finding segments needing review ──────────────────────────────────
-- Fast lookup: "show me all segments corrected by this user"
...
-- Fast lookup: "show me all segments without corrections"
